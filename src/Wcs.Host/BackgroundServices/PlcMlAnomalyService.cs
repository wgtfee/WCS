...
public sealed class PlcMlAnomalyService : BackgroundService
{
    private readonly IEventBus _eventBus;
    private readonly IPlcMlAnomalyEngine _engine;
    private readonly PlcMlAnomalyOptions _options;
    private readonly ILogger<PlcMlAnomalyService> _logger;

    public PlcMlAnomalyService(
        IEventBus eventBus,
        IPlcMlAnomalyEngine engine,
        PlcMlAnomalyOptions options,
        ILogger<PlcMlAnomalyService> logger)
    {
        _eventBus = eventBus;
        _engine = engine;
        _options = options;
