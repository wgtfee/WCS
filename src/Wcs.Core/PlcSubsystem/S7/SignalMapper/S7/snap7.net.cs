...
namespace Snap7
{
    ...
    public static class S7
    {
        ...
        public static string GetStringAt(byte[] Buffer, int Pos, int size)
        {
            // int size = 15;//Buffer[Pos + 1];
            //int qw = Buffer.Length;
            return Encoding.UTF8.GetString(Buffer, Pos + 2, size);

        }
        /// <summary>
        /// 编码字符，字节插入位置，当前字符串数量，字符串
        /// </summary>
    ...
    public class S7Client
    {
        ...
        public static readonly uint errTCPDataReceive = 0x00000005;
        public static readonly uint errTCPConnectionFailed = 0x00000003;
        public static readonly uint errTCPDataSend = 0x00000004;
        // Area ID
